...
- Date: 2020.10.27
- Brief: Deal with CrayoDataset with DecisionTree_v4.
"""
import re
...
# generate decision tree, MaxDepth = None
decisionTree = DecisionTree(train_xs, train_ys, test_xs, test_ys, attributes, isdiscs, labels)
decisionTree.buildTree(MaxDepth=None, partIndex='InformationGain')
decisionTree.visualize("MaxDepth=None")
# generate decision tree, MaxDepth = 4
decisionTree.buildTree(MaxDepth=4, partIndex='InformationGain')
decisionTree.visualize("MaxDepth=4")